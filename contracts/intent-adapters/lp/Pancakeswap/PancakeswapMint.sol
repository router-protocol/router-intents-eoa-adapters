...
import {PancakeswapHelpers} from "./PancakeswapHelpers.sol";
    ...
    PancakeswapHelpers
{
    ...
    event PancakeswapMintPositionDest();
    ...
    {
        return
            abi.decode(data, (IPancakeswapNonfungiblePositionManager.MintParams));
    }
