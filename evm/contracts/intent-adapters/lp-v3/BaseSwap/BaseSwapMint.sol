...
import {BaseSwapHelpers} from "./BaseSwapHelpers.sol";

/**
 * @title BaseSwapMint
 * @author Yashika Goyal
 * @notice Minting a new position on BaseSwap.
 */
contract BaseSwapMint is RouterIntentEoaAdapterWithoutDataProvider, BaseSwapHelpers {
    ...
    constructor(
        ...
        BaseSwapHelpers(__nonFungiblePositionManager)
