...
import {CamelotHelpers} from "./CamelotHelpers.sol";

/**
 * @title CamelotMint
 * @author Yashika Goyal
 * @notice Minting a new position on Camelot.
 */
contract CamelotMint is RouterIntentEoaAdapterWithoutDataProvider, CamelotHelpers {
    ...
    constructor(
        ...
        CamelotHelpers(__nonFungiblePositionManager)
    ...
    function execute(
        ...
        ICamelotNonfungiblePositionManager.MintParams
    ...
    function _mint(
        ICamelotNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (ICamelotNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (ICamelotNonfungiblePositionManager.MintParams));
    }
