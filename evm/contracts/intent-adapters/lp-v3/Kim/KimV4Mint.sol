...
import {KimHelpers} from "./KimV4Helpers.sol";

/**
 * @title KimV4Mint
 * @author Yashika Goyal
 * @notice Minting a new position on Kim Protocol.
 */
contract KimV4Mint is RouterIntentEoaAdapterWithoutDataProvider, KimHelpers {
    ...
    constructor(
        ...
        KimHelpers(__nonFungiblePositionManager)
    ...
    function execute(
        ...
        IKimNonfungiblePositionManager.MintParams
    ...
    function _mint(
        IKimNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (IKimNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (IKimNonfungiblePositionManager.MintParams));
    }
