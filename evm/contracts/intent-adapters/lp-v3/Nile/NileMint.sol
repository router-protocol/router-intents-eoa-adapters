...
import {NileHelpers} from "./NileMintHelpers.sol";
 ...
 */
contract NileMint is RouterIntentEoaAdapterWithoutDataProvider, NileHelpers {
    ...
    constructor(
        ...
        NileHelpers(__nonFungiblePositionManager)
    ...
    function execute(
        ...
        INileNonFungiblePositionManager.MintParams
    ...
    function _mint(
        INileNonFungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (INileNonFungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (INileNonFungiblePositionManager.MintParams));
    }
