...
import {INuriNonfungiblePositionManager} from "./Interfaces.sol";
 ...
 * @notice Minting a new position on Nuri.
 */
contract NuriMint is RouterIntentEoaAdapterWithoutDataProvider {
    using SafeERC20 for IERC20;
    INuriNonfungiblePositionManager
    ...
    {
        nonFungiblePositionManager = INuriNonfungiblePositionManager(
    ...
    function _mint(
        INuriNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (INuriNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(
                data,
