...
import {IScribeNonfungiblePositionManager} from "./Interfaces.sol";
 ...
 * @notice Minting a new position on Scribe Protocol.
 */
contract ScribeMint is RouterIntentEoaAdapterWithoutDataProvider {
    using SafeERC20 for IERC20;
    IScribeNonfungiblePositionManager
    ...
    {
        nonFungiblePositionManager = IScribeNonfungiblePositionManager(
    ...
    function execute(
        ...
        IScribeNonfungiblePositionManager.MintParams
    ...
    function _mint(
        IScribeNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (IScribeNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (IScribeNonfungiblePositionManager.MintParams));
    }
