...
import {SwapModeHelpers} from "./SwapModeHelpers.sol";

/**
 * @title SwapModeMint
 * @author Yashika Goyal
 * @notice Minting a new position on Swap Mode.
 */
contract SwapModeMint is RouterIntentEoaAdapterWithoutDataProvider, SwapModeHelpers {
    ...
    constructor(
        ...
        SwapModeHelpers(__nonFungiblePositionManager)
