...
import {ThenaHelpers} from "./ThenaHelpers.sol";

/**
 * @title ThenaMint
 * @author Yashika Goyal
 * @notice Minting a new position on Thena.
 */
contract ThenaMint is RouterIntentEoaAdapterWithoutDataProvider, ThenaHelpers {
    ...
    constructor(
        ...
        ThenaHelpers(__nonFungiblePositionManager)
    ...
    function _mint(
        IThenaNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (IThenaNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (IThenaNonfungiblePositionManager.MintParams));
    }
