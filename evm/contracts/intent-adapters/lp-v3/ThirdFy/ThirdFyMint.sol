 ...
 * @notice Minting a new position on ThirdFy Protocol.
 */
contract ThirdFyMint is RouterIntentEoaAdapterWithoutDataProvider, ThirdFyHelpers {
    ...
    constructor(
        ...
        ThirdFyHelpers(__nonFungiblePositionManager)
    ...
    function execute(
        ...
        IThirdFyNonfungiblePositionManager.MintParams
    ...
    function _mint(
        IThirdFyNonfungiblePositionManager.MintParams memory mintParams
    ...
    function parseInputs(
        ...
        public
        pure
        returns (IThirdFyNonfungiblePositionManager.MintParams memory)
    {
        return
            abi.decode(data, (IThirdFyNonfungiblePositionManager.MintParams));
    }
