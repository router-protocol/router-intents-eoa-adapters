...
export const DEPLOY_INIT_OPEN_POSITION_ADAPTER = "DEPLOY_INIT_OPEN_POSITION_ADAPTER";
export const VERIFY_INIT_OPEN_POSITION_ADAPTER = "VERIFY_INIT_OPEN_POSITION_ADAPTER";
...
export const CONTRACT_NAME: { [key: string]: string } = {
  ...
  RingMint: "RingMint",
  InitOpenPosition: "InitOpenPosition"
};
