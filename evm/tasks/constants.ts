...
export const DEPLOY_ETHERFI_STABLES_DEPOSITS_ADAPTER =
  "DEPLOY_ETHERFI_STABLES_DEPOSITS_ADAPTER";
export const VERIFY_ETHERFI_STABLES_DEPOSITS_ADAPTER =
...
export const CONTRACT_NAME: { [key: string]: string } = {
  ...
  EtherFiStablesDepositsVault: "EtherFiStablesDepositsVault",
};
