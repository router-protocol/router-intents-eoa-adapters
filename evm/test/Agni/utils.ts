...
const AGNI_V3_FACTORY: { [chainId: string]: string } = {
  "5000": "0x25780dc8Fc3cfBD75F33bFDAB65e969b603b2035",
};
...
export const getPoolData = async (
  ...
  const factoryAddress = AGNI_V3_FACTORY[chainId];
...
export const getAgniData = async (data: {
  user: Wallet;
  chainId: string;
  token0: string;
  token1: string;
