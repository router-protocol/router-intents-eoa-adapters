...
const NURI_FACTORY: { [chainId: string]: string } = {
  "534352": "0xAAA32926fcE6bE95ea2c51cB4Fcb60836D320C42",
};
...
export const getPoolData = async (
  ...
  const factoryAddress = NURI_FACTORY[chainId];
...
export const getNuriData = async (data: {
  user: Wallet;
  chainId: string;
  token0: string;
  token1: string;
