...
describe("SwellStakeEth Adapter: ", async () => {
  ...
  it("Can stake ETH on Swell on dest chain when instruction is received directly on SwellStakeEth adapter", async () => {
    const { swellStakeEthAdapter, swEth, mockAssetForwarder } =
      await setupTests();
